...
export default function Create({ auth, teams }: {auth: PageProps, teams: Array<Team>}) {
                    ...
                    <div className="mt-3 flex">
                        <div className="basis-3/4">
                            ...
                            <select
                                ...
                                {teams.map((team, index) => <option key={team.id} value={team.id} selected={index == 0}>{team.name}</option>)}
                            </select>
